					...
					<table width="100%">
						<thead>
							<tr>
								...
								<th><span class="las la-sort"></span>Client Evaluation Status</th>
							...
							<tr>
								...
								<td>
									<div class="client">
										<div class="client-info">
												<c:choose>
													<c:when test="${ev.getClnt_evln_date()==null}">
													<h4>Pending</h4>
													</c:when>
													<c:otherwise><h4>Selected <br> on <fmt:formatDate value="${ev.getClnt_evln_date()}" pattern="dd-MM-yyyy"/></h4>
													</c:otherwise>
												</c:choose>
								...
								<td>
									<div class="actions">
									<a href="<%=request.getContextPath()%>/clientavaluate/${ev.getEvaluation_id()}/${ev.getCand_name()}/${ev.getThrough()}/${ev.getGrade()}/${ev.getLocation()}/${ev.getEsource()}/${ev.getSkill()}/${ev.getBr_number()}/${admin_id}/${admin_name}/${admin_role}">
